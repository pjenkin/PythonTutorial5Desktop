...
books_list.bind('<<ListboxSelect>>', frontend.get_selected_row)
...
view_all_button = Button(window, text="View all", width=12, command=frontend.view_command)   # no brackets, and for some reason not database.view
...
search_entry_button = Button(window, text="Search entry", width=12, command=frontend.search_command)
search_entry_button.grid(row=3, column=3)

add_entry_button = Button(window, text="Add entry", width=12, command=frontend.add_command)
add_entry_button.grid(row=4, column=3)

update_button = Button(window, text="Update", width=12, command=frontend.update_command)
update_button.grid(row=5, column=3)

delete_button = Button(window, text="Delete", width=12, command=frontend.delete_command)
